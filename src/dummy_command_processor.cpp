...
void DummyCommandProcessor::add_writer(IWriter* writer)
{
    assert(writer != nullptr);
    m_writers.emplace(writer);
}

void DummyCommandProcessor::add_writer(FileWriter* writer)
{
    assert(writer != nullptr);
    m_file_writers.emplace(writer);
}

void DummyCommandProcessor::remove_writer(IWriter* writer)
{
